...
const IndexInner = () => {
  ...
  const widgetDefs: Array<{ id: string; node: React.ReactNode; lg: GridWidget["lg"]; always?: boolean; adminOnly?: boolean }> = [
    ...
    { id: "today_care",           node: <TodayCareWidget />,               lg: { x: 0,  y: 4,   w: 12, h: 5 } },
    { id: "top_product",          node: <TopProductScoreboard />,          lg: { x: 0,  y: 9,   w: 6,  h: 6 }, always: true },
    { id: "pending_product",      node: <PendingProductScoreboard />,      lg: { x: 6,  y: 9,   w: 6,  h: 6 }, always: true },
